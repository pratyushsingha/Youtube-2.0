        ...
        <div className="flex justify-between py-4 mx-5">
            ...
            <div className="flex">
                <input type="text" value={search} onChange={changeHandler}
                    className="d-inline-block w-96 d-lg-none flex-order-1 f5 no-underline border color-border-default bg-inherit rounded-2 px-2 py-1 color-fg-inherit text-black rounded-3xl"
                    placeholder="search" />
                <svg className="cursor-pointer" onClick={submitHandler} xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="48" height="48" viewBox="0 0 48 48">
