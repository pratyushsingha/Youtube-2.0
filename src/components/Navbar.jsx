        ...
        <div className="flex justify-between py-4 mx-5">
            ...
            <div className="flex">
                <input type="text" value={search} onChange={changeHandler}
                    className="d-inline-block w-full d-lg-none flex-order-1 f5 no-underline border color-border-default bg-inherit rounded-2 px-2 py-1 color-fg-inherit text-black rounded-3xl"
                    placeholder="search" />
